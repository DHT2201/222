        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-menu">
                    <img src="asset/image/logo/logo-website.png" alt="logo" class="img-fluid"
                ...
                <div class="footer-menu">
                    ...
                    <ul class="menu-list list-unstyled text-black text-truncate">
                            <?php 
                                ...
                                $datas = $productController->getProductByHightViewController();
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-menu">
                    <h5 class="widget-title">Đăng ký để nhận thông báo khuyến mãi</h5>
                    <p>Email sẽ gửi thông báo khi có khuyến mãi</p>

                    <form class="d-flex mt-3 gap-0" action="" method="post">
                        <input class="form-control rounded-start rounded-0 bg-light text-black"
                            type="email" placeholder="Địa chỉ email"
                            aria-label="Email Address">
                        <button class="btn btn-primary active rounded-end rounded-0"
