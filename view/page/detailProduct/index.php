...
$conn = mysqli_connect("localhost", "root", "", "projectfinal");
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
}

if(isset($_POST['addtocart'])){
   // echo ' theemvao gio'; die();
   // add to cart 
   $id = $_POST['idp'];
   $cart = [];
   ...
   if(!$isFound){// khoong tim thay san pham
                ...
                <div class="col-md-6">
                    ...
                    foreach ($dataUsers as $dataUser) {
                        echo '<div class="d-flex align-items-center mt-2">
                            ...
                            <div class="d-flex align-items-center justify-content-evenly mt-4">
                                ...
                                <a href="index.php?page=message" class="text-decoration-none btn-link p-2 d-flex align-items-center">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-start align-items-center mt-3">
                            ...
                            <button class="btn btn-primary rounded-1 p-2 d-flex align-items-center active" name="addtocart">
                            ...
                            <button type="submit" class="btn btn-outline-danger rounded-1 p-2 d-flex align-items-center ms-3">
